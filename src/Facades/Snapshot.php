 ...
 * @method static void                             restore(string $snapshotId, mixed $context, mixed $restoredBy = null)                                                                          Restore all features from a snapshot to the specified context.
 * @method static void                             restorePartial(string $snapshotId, mixed $context, array<int, string> $features, mixed $restoredBy = null)                                     Restore only specific features from a snapshot to the context.
 * @method static array<string, mixed>|null        get(string $snapshotId, mixed $context)                                                                                                        Retrieve the feature data stored in a snapshot. Returns null if not found.
 * @method static array<int, array<string, mixed>> list(mixed $context)                                                                                                                           List all snapshots for a given context.
 * @method static void                             delete(string $snapshotId, mixed $context, mixed $deletedBy = null)                                                                            Delete a specific snapshot.
 * @method static void                             clearAll(mixed $context, mixed $deletedBy = null)                                                                                              Delete all snapshots for a context.
 * @method static array<int, array<string, mixed>> getEventHistory(string $snapshotId)                                                                                                            Retrieve the event history for a snapshot.

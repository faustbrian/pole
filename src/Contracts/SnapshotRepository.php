...
interface SnapshotRepository
{
     ...
     *
     * @param string             $snapshotId Unique identifier of the snapshot
     ...
     *
     * @param string     $snapshotId Unique snapshot identifier to delete
     * @param mixed      $context    Context that owns the snapshot
     ...
     */
    public function getEventHistory(string $snapshotId): array;

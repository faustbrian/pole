...
use Cline\Toggl\Database\GroupMembership;
...
/**
 * GroupMembership Model Test Suite
 *
 * Tests the GroupMembership Eloquent model, specifically focusing on:
 ...
 * - Metadata handling in group memberships
 *
 * These tests ensure 100% coverage of the GroupMembership database model.
 */
describe('GroupMembership Model', function (): void {
    describe('context() Relationship', function (): void {
        describe('Happy Paths', function (): void {
            ...
            test('multiple memberships can share same User context', function (): void {
                ...
                $membership1 = GroupMembership::query()->create([
                ...
                $membership2 = GroupMembership::query()->create([
            ...
            test('can query memberships by context type', function (): void {
                ...
                // Act
                $userMemberships = GroupMembership::query()
                    ->where('context_type', User::class)
                    ->get();

                $orgMemberships = GroupMembership::query()
        ...
        describe('Edge Cases', function (): void {
            test('context returns null when context model does not exist', function (): void {
                ...
                $membership = GroupMembership::query()->create([
                    ...
                    'context_type' => User::class,
                    'context_id' => 999_999, // Non-existent ID
                ]);

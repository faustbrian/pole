...
describe('Rollout Conductor', function (): void {
    ...
    describe('Real-World Scenarios', function (): void {
        test('gradual new UI rollout', function (): void {
            ...
            // Assert phase 1 - allow 30% variance for 10% rollout
            expect($phase1Active)->toBeGreaterThanOrEqual(70);
            expect($phase1Active)->toBeLessThanOrEqual(130);
            ...
            // Assert phase 2
            expect($phase2Active)->toBeGreaterThan($phase1Active);
            expect($phase2Active)->toBeGreaterThanOrEqual(450);
            expect($phase2Active)->toBeLessThanOrEqual(550);
        });
